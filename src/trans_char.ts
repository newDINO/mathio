export function is_ascii_upper_char(code: number): boolean {
	return code >= 65 && code <= 90
}
export function is_ascii_lower_char(code: number): boolean {
	return code >= 97 && code <= 122 
}
export function char_to_bold(s: string): string {
